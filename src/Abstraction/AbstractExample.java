...
abstract class Dog {
	// Methods that are pre-implemented
	public void species() {
	...
	public abstract void name(); // Abstract Method that MUST be implemented

	public abstract void walk(); // Abstract Method that MUST be implemented
}
